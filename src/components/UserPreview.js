...
const UserPreview = (props) => {
    ...
    const viewFeedback = (id) => {
        ...
        // });
        if (resumeInfo.comment === null || resumeInfo.comment === "") {
            swal("No Feedback yet");
        } else {
            swal(`${resumeInfo.comment}`)
        }
    }
    ...
    const exportResume = () => {
        ...
        const ele = document.querySelector('#printable');
        console.log(ele)
    ...
    return (
        ...
        <section className="preview" style={{ backgroundImage: "url(/ground.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
            ...
            <div ref={templateRef} id="printable" className='preResume' style={{ backgroundImage: "url(/hd.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover" }} >
                <div className='gt'>
